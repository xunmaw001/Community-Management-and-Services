...
public class DiscussshequhuodongController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussshequhuodongEntity discussshequhuodong, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussshequhuodongEntity discussshequhuodong, HttpServletRequest request){
        EntityWrapper<DiscussshequhuodongEntity> ew = new EntityWrapper<DiscussshequhuodongEntity>();
    	PageUtils page = discussshequhuodongService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussshequhuodong), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
