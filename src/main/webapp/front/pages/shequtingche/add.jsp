		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.cheweimingcheng" type="text" name="cheweimingcheng" id="cheweimingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="cheweizhuangtai" id="cheweizhuangtai" lay-filter="cheweizhuangtai">
                                ...
                                <option v-for="(item,index) in cheweizhuangtai" v-bind:key="index" :value="item">{{item}}</option>
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">每小时价格：</label>
						<div class="layui-input-block">
							<input v-model="detail.meixiaoshijiage" type="text" name="meixiaoshijiage" id="meixiaoshijiage" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																								...
																								vue.cheweileixing = '居民停车位,临时停车位'.split(',')
																vue.cheweizhuangtai = '空闲,占用'.split(',')
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                        ...
                                                                                                                                                                                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                        if(!isIntNumer(data.meixiaoshijiage)){
                        layer.msg('每小时价格应输入整数', {
							time: 2000,
							icon: 5
						});
                        return false
					...
					// 提交数据
					http.requestJson('shequtingche' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
