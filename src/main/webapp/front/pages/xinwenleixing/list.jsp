          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="xinwenleixing" id="xinwenleixing" placeholder="新闻类型" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('xinwenleixing','新增')" @click="jump('../xinwenleixing/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../xinwenleixing/detail.jsp?id='+item.id">
                <div class="posi-img">
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xinwenleixing').val()) {
          param['xinwenleixing'] = jquery('#xinwenleixing').val() ? '%' + jquery('#xinwenleixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('xinwenleixing/list', 'get', param, function(res) {
