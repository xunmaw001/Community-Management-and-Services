				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shequgonggongchangsuo','预约')" @click="onAcrossTap('gonggongchangsuoyuyue')" type="button" class="layui-btn">
								预约
							</button>
		...
		<script>
			var vue = new Vue({
				...
				data: {
					...
					buynumber: 1,
					// 当前详情页表
					detailTable: 'shequgonggongchangsuo',
					// 评价列表
					dataList: [],
					// 选座座位列表
					numberList: []
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shequgonggongchangsuo`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.changsuomingcheng;
																														// 轮播图片
