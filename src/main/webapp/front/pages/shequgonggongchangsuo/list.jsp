          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="changsuomingcheng" id="changsuomingcheng" placeholder="场所名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('shequgonggongchangsuo','新增')" @click="jump('../shequgonggongchangsuo/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../shequgonggongchangsuo/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.fengmiantupian?item.fengmiantupian.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.changsuomingcheng}}</h5>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#changsuomingcheng').val()) {
          param['changsuomingcheng'] = jquery('#changsuomingcheng').val() ? '%' + jquery('#changsuomingcheng').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('shequgonggongchangsuo/list', 'get', param, function(res) {
