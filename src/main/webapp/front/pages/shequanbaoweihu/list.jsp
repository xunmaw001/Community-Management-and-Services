        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="weihuleixing" id="weihuleixing" placeholder="维护类型" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('shequanbaoweihu','新增')" @click="jump('../shequanbaoweihu/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../shequanbaoweihu/detail.jsp?id='+item.id">
                <div class="posi-img">
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#weihuleixing').val()) {
          param['weihuleixing'] = jquery('#weihuleixing').val() ? '%' + jquery('#weihuleixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('shequanbaoweihu/list', 'get', param, function(res) {
