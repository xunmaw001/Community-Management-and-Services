...
<body>
    ...
    <div class="plate">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in shequzhengwufuwuList" v-bind:key="index">
                <a target="_self" :href="'../shequzhengwufuwu/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.fengmiantupian?item.fengmiantupian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.fuwumingcheng}}</h5>
                    <p v-if="item.price">{{item.price}} RMB</p>
                  </div>
                </a>
              </li>
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in shequhuodongList" v-bind:key="index">
                <a target="_self" :href="'../shequhuodong/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.huodongtupian?item.huodongtupian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.huodongmingcheng}}</h5>
                    <p v-if="item.price">{{item.price}} RMB</p>
                  </div>
                </a>
              </li>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`shequzhengwufuwu/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shequzhengwufuwuList = res.data.list;
      });
