								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="fankuileixingSelect" name="fankuileixing" class="form-control">
												<option value=""></option>
												<option class="fankuileixingOption" value="投诉">
													投诉
												</option>
												<option class="fankuileixingOption" value="保修">
													保修
												</option>
												<option class="fankuileixingOption" value="建议">
													建议
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>反馈内容</label>
										<textarea name="fankuineirong" class="form-control" id="fankuineirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>用户账号</label>
