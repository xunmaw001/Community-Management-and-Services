...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">社区公共场所管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>社区公共场所管理</span></li>
								<li class="breadcrumb-item active"><span>社区公共场所列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">社区公共场所列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										场所名称
									</label>
									<input type="text" id="changsuomingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('changsuomingcheng')">场所名称<i id="changsuomingchengIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		var tableName = "shequgonggongchangsuo";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
		...
		function search(){
			searchForm = { key: ""};
			if($('#changsuomingchengSearch').val() != null && $('#changsuomingchengSearch').val() != ''){
				searchForm.changsuomingcheng ="%" +  $('#changsuomingchengSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("shequgonggongchangsuo/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				changsuomingcheng : searchForm.changsuomingcheng,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var changsuomingchengCell  = document.createElement('td');

						 changsuomingchengCell.innerHTML = item.changsuomingcheng;


			row.appendChild(changsuomingchengCell);
			...
			var yongtuCell  = document.createElement('td');
						  ...
						  if(item.yongtu != null && item.yongtu != "" && item.yongtu.length >= 11){
			  	yongtuCell.innerHTML = item.yongtu.substring(0, 10) + "..."; 
			  }else{
			...
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"gonggongchangsuoyuyue\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shequgonggongchangsuo/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("shequgonggongchangsuo"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shequgonggongchangsuo");
