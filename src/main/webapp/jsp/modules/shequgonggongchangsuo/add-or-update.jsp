		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑社区公共场所</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑社区公共场所</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">社区公共场所信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>场所名称</label>
										<input id="changsuomingcheng" name="changsuomingcheng" class="form-control" placeholder="场所名称">
									</div>
									<div class="form-group col-md-6">
										<label>地点</label>
									...
									<div class="form-group col-md-6">
										<label>用途</label>
										<textarea name="yongtu" class="form-control" id="yongtu" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>负责人</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shequgonggongchangsuo/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shequgonggongchangsuo/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shequgonggongchangsuo/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#changsuomingcheng").val(ruleForm.changsuomingcheng);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.changsuomingcheng != null && res.data.changsuomingcheng != ''){

					$("#changsuomingcheng").val(res.data.changsuomingcheng);
					}
					...
					if(res.data != null && res.data != '' && res.data.yongtu != null && res.data.yongtu != ''){

					$("#yongtu").val(res.data.yongtu);
					}
