							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>服务名称</label>
										<input id="fuwumingcheng" name="fuwumingcheng" class="form-control" placeholder="服务名称">
									</div>
									<div class="form-group col-md-6">
										<label>服务类型</label>
									...
									<div class="form-group col-md-6">
										<label>服务时间段</label>
										<textarea name="fuwushijianduan" class="form-control" id="fuwushijianduan" rows="3"></textarea>
									</div>
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shequzhengwufuwu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getContent(){
			if(UE.getEditor('fuwuneirongEditor').hasContents()){
				$('#fuwuneirong-input').attr('value',UE.getEditor('fuwuneirongEditor').getPlainTxt());
			}
		}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shequzhengwufuwu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#fuwushijianduan").val(ruleForm.fuwushijianduan);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.fuwushijianduan != null && res.data.fuwushijianduan != ''){

					$("#fuwushijianduan").val(res.data.fuwushijianduan);
					}
